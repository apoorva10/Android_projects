...
public class WeatherForecast1 {
    private List<DayForecast1> daysForecast = new ArrayList<DayForecast1>();

    public void addForecast(DayForecast1 forecast) {
        daysForecast.add(forecast);
        System.out.println("Add forecast [" + forecast + "]");
    }

    public DayForecast1 getForecast(int dayNum) {
