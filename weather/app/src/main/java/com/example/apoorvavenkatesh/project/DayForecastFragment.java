...
public class DayForecastFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        boolean var=true;
        /*if(dayForecast.forecastTemp.max>90 && var)
        {
            new AlertDialog.Builder(getContext()).setTitle("Weather").setMessage("Tomorrow temperature is more than 90... Stay Cool!!!").setNeutralButton("Close", null).show();
            var=false;
        }*/
        tempView.setText( (int) (dayForecast.forecastTemp.min - 275.15) + "-" + (int) (dayForecast.forecastTemp.max - 275.15)+"°F" );
