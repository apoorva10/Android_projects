...
public class WeatherHttpClient {
    ...
    private static String LAST = "&appid=f141f2583b595d47cbdce7ef92e9e61f";
    ...
    public String getWeatherData(String location, String lang) {
        ...
        try {
            ...
            if (lang != null)
                url = url + "&lang=" +lang+ LAST;

            con = (HttpURLConnection) ( new URL("http://api.openweathermap.org/data/2.5/weather?q="+location+",%20US&lang=en&appid=f141f2583b595d47cbdce7ef92e9e61f")).openConnection();
    ...
    public String getForecastWeatherData(String location, String lang, String sForecastDayNum) {
        System.out.println("From method"+location);
        HttpURLConnection con = null ;
        InputStream is = null;
        ...
        try {
            ...
            con = (HttpURLConnection) ( new URL("http://api.openweathermap.org/data/2.5/forecast/daily?mode=json&q="+location+",%20US&lang=en&appid=f141f2583b595d47cbdce7ef92e9e61f&cnt=3")).openConnection();
            con.setRequestMethod("GET");
            con.setDoInput(true);
            con.setDoOutput(true);
            con.connect();
