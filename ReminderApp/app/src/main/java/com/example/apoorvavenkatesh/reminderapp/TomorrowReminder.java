...
public class TomorrowReminder extends Fragment{

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.fragement_tomorrowreminder, container, false);
        ...
        try {
            alarms = remind.getAlarms(container.getContext(), day);
