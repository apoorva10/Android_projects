 ...
 * becomes available.
 */
public class GeoMain extends ActionBarActivity implements
    ...
    public void populateGeofenceList() {
        for (Map.Entry<String, LatLng> entry : GeoData.AREA_REQUIRED.entrySet()) {
    ...
    public void addGeofenceList(String geoname,String lat, String longi, String radi) {

                mGeofenceList.add(new Geofence.Builder()
                .setRequestId(geoname)
                .setCircularRegion(Double.parseDouble(lat), Double.parseDouble(longi),Float.parseFloat(radi))
                .setExpirationDuration(Constants.GEOFENCE_EXPIRATION_IN_MILLISECONDS)
                .setTransitionTypes(Geofence.GEOFENCE_TRANSITION_ENTER |
                        Geofence.GEOFENCE_TRANSITION_EXIT)
                .build());
